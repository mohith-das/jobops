...
\begin{tabular}{rl}
\textsf{\small\bfseries Version} & \texttt{0.9.3} \\
...
One process. Three planes. Six MCP resources and 41 tools.
...
Restart Claude Desktop. The 38--41 tools should appear in the tool picker.
...
41 tools, grouped by what they do. For each: what it does, key parameters, what it returns. The default mode for tools that take one is \texttt{chat} \textemdash{} the chat client is the brain; \texttt{api} mode is the LLM-direct path and needs an API key.
