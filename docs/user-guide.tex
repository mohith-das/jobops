...
\begin{tabular}{rl}
\textsf{\small\bfseries Version} & \texttt{0.6.0} \\
...
The six files in \fpath{modes/} are exposed as MCP resources and live-reloaded on edit (the server watches the directory). After saving, the chat picks up the change on the next \texttt{resources/read} \textemdash{} no restart.
