...
\item[\tool{render\_pdf}] Chromium HTML\textrightarrow{}PDF. \texttt{kind: resume | cover | both}, optional \texttt{cover\_body}, \texttt{page\_format}. Returns localhost link(s). Scans \texttt{cover\_body} for visa leakage before render \textemdash{} fails loud if a leak slips through.
